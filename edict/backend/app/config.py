...
class Settings(BaseSettings):
    ...
    # ── Community Edition ──
    raccoonclaw_data_profile: str = "clean"
    raccoonclaw_enable_im_channels: bool = False
    raccoonclaw_enable_toolbox: bool = False
    raccoonclaw_enable_scheduled_tasks: bool = False
    raccoonclaw_enable_automation_mirrors: bool = False

    @property
    def database_url(self) -> str:
        if self.database_url_override:
            return self.database_url_override
        # 强制默认使用 SQLite，移除对 asyncpg 的强依赖
