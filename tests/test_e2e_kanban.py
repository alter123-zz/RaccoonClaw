...
sys.path.insert(0, str(ROOT / "edict" / "scripts"))
...
class KanbanE2ETests(unittest.TestCase):
    ...
    def test_dirty_title_cleaned_before_create(self) -> None:
        kb.cmd_create(
            "JJC-TEST-E2E-01",
            "全面审查/Users/bingsen/clawd/RaccoonClaw-OSS/这个项目\nConversation info (xxx)",
            "Planning",
            "产品规划部",
            "产品规划负责人",
            "总裁办整理需求",
    ...
    def test_pure_path_rejected(self) -> None:
        kb.cmd_create(
            "JJC-TEST-E2E-02",
            "/Users/bingsen/clawd/RaccoonClaw-OSS/",
            "Planning",
            "产品规划部",
            "产品规划负责人",
        )
    ...
    def test_flow_remark_cleaned(self) -> None:
        kb.cmd_flow(
            ...
            "总裁办",
            "产品规划部",
            "需求传达：审查/Users/bingsen/clawd/xxx项目 Conversation blah",
        )
    ...
    def test_progress_sanitizes_text_and_updates_todos(self) -> None:
        kb.cmd_progress(
            "JJC-TEST-E2E-08",
            "已完成第一轮排查 /Users/bingsen/trace.log Conversation detail",
            "梳理问题✅|复现实验🔄|补充报告",
        )
